...
# Project:  QTGL.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang -o Makefile QTGL.pro
#############################################################################
...
CXXFLAGS      = -pipe -msse -msse2 -msse3 -march=native -O2 -std=c++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -Iinclude -I/home/i7624405/NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtOpenGL -I/opt/qt/5.5/gcc_64/include/QtWidgets -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -I. -I/opt/qt/5.5/gcc_64/mkspecs/linux-clang
...
COMPRESS      = gzip -9f
DISTNAME      = QTGL1.0.0
DISTDIR = /home/i7624405/CA1/personal/02/obj/QTGL1.0.0
LINK          = clang++
...
OBJECTS       = obj/main.o \
		obj/QTGLScene.o \
		obj/Texture.o
DIST          = QTGL.pro include/QTGLScene.hpp \
		include/Texture.hpp src/main.cpp \
		src/QTGLScene.cpp \
		src/Texture.cpp
QMAKE_TARGET  = QTGL
...
Makefile: QTGL.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang -o Makefile QTGL.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/QTGLScene.hpp include/Texture.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/QTGLScene.cpp src/Texture.cpp $(DISTDIR)/
...
obj/QTGLScene.o: src/QTGLScene.cpp /opt/qt/5.5/gcc_64/include/QtGui/QGuiApplication \
		/opt/qt/5.5/gcc_64/include/QtGui/qguiapplication.h \
		/opt/qt/5.5/gcc_64/include/QtCore/qcoreapplication.h \
		/opt/qt/5.5/gcc_64/include/QtCore/qglobal.h \
		/opt/qt/5.5/gcc_64/include/QtCore/qconfig.h \
		...
		/home/i7624405/NGL/include/ngl/NGLInit.h \
		...
		/opt/qt/5.5/gcc_64/include/QtCore/qdatetime.h \
		include/Texture.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/QTGLScene.o src/QTGLScene.cpp
